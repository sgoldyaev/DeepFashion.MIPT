...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--dirSem', required=False, help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
    ...
    def parse(self):
        ...
        self.opt.isTrain = False # self.isTrain   # train or test
